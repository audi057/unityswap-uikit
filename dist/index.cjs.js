...
var ButtonMenuItem = function (_a) {
    ...
    return React__default['default'].createElement(Button, __assign({ as: as, size: size, variant: "primary" }, props));
};
...
var SpinnerIcon = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 96 96" }, props),
        React__default['default'].createElement("svg", { xmlns: "http://www.w3.org/2000/svg", fill: "none", viewBox: "0 0 24 24" },
...
var shadows = {
    ...
    active: "0px 0px 0px 1px #048e08, 0px 0px 4px 8px #048e089e",
    success: "0px 0px 0px 1px #31D0AA, 0px 0px 4px 4px #31D0AA",
    warning: "0px 0px 0px 1px #ED4B9E, 0px 0px 0px 4px rgba(237, 75, 158, 0.2)",
    focus: "0px 0px 0px 1px #048e08, 0px 0px 0px 4px #048e089e",
...
var Logo = function (_a) {
    ...
    return (React__default['default'].createElement(MenuLink, { href: "https://defi.finance/" },
        React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 205 26" }, props),
            React__default['default'].createElement("image", { width: "205", height: "26", href: isDark ? '/images/egg/logo-light.png'
                    :
                        '/images/egg/logo-dark.png' }))));
};
...
var Logo$1 = function (_a) {
    ...
    return (React__default['default'].createElement(Flex, null, isAbsoluteUrl ? (React__default['default'].createElement(StyledLink$1, { as: "a", href: href, "aria-label": "Defix home page" }, innerLogo)) : (React__default['default'].createElement(StyledLink$1, { to: href, "aria-label": "Defix home page" }, innerLogo))));
};
...
var UserBlock = function (_a) {
    ...
    return (account ? (React__default['default'].createElement(Button, { size: "sm", variant: "tertiary", onClick: function () {
...
var Alert$1 = styled__default['default'].div(templateObject_2$e || (templateObject_2$e = __makeTemplateObject(["\n  position: relative;\n  width: 100%;\n  background-color:red;\n  z-index: 99;\n  color:#FFFFFF;\n  text-align:center;\n  padding:3px;\n  font-size:13px;\n"], ["\n  position: relative;\n  width: 100%;\n  background-color:red;\n  z-index: 99;\n  color:#FFFFFF;\n  text-align:center;\n  padding:3px;\n  font-size:13px;\n"])));
var SubNavContainer = styled__default['default'].div(templateObject_3$7 || (templateObject_3$7 = __makeTemplateObject(["\ndisplay: flex;\njustify-content: space-between;\n\n\n"], ["\ndisplay: flex;\njustify-content: space-between;\n\n\n"])));
var StyledNav = styled__default['default'].nav(templateObject_4$2 || (templateObject_4$2 = __makeTemplateObject(["\n  position: fixed;\n  top: ", ";\n  left: 0;\n  transition: top 0.2s;\n\n  align-items: center;\n\n\n  width: 100%;\n  height: auto;\n  background-color: ", ";\n  border-bottom: solid 2px rgba(133, 133, 133, 0.1);\n  z-index: 20;\n  transform: translate3d(0, 0, 0);\n  \n"], ["\n  position: fixed;\n  top: ", ";\n  left: 0;\n  transition: top 0.2s;\n\n  align-items: center;\n\n\n  width: 100%;\n  height: auto;\n  background-color: ", ";\n  border-bottom: solid 2px rgba(133, 133, 133, 0.1);\n  z-index: 20;\n  transform: translate3d(0, 0, 0);\n  \n"])), function (_a) {
...
var ConnectContainer = styled__default['default'].div(templateObject_6 || (templateObject_6 = __makeTemplateObject(["\n  display: flex;\n  align-items: center;\n  justify-content: space-between;\n"], ["\n  display: flex;\n  align-items: center;\n  justify-content: space-between;\n"])));
...
styled__default['default'].a(templateObject_10 || (templateObject_10 = __makeTemplateObject(["\n  display: flex;\n  align-items: center;\n  svg {\n    transition: transform 0.3s;\n  }\n  :hover {\n    svg {\n      transform: scale(1.2);\n    }\n  }\n"], ["\n  display: flex;\n  align-items: center;\n  svg {\n    transition: transform 0.3s;\n  }\n  :hover {\n    svg {\n      transform: scale(1.2);\n    }\n  }\n"])));
var Menu = function (_a) {
    ...
    return (React__default['default'].createElement(Wrapper$1, null,
        React__default['default'].createElement(StyledNav, { showMenu: showMenu },
            React__default['default'].createElement(Alert$1, null, "BETA VERSION. CONTRACTS BEEING AUDITED. USE AT YOUR OWN RISK. FARMS AND STAKING WILL BE ACTIVE SOON. STAY TUNNED.BETA VERSION. CONTRACTS BEEING AUDITED. USE AT YOUR OWN RISK."),
            React__default['default'].createElement(SubNavContainer, null,
                React__default['default'].createElement(ConnectContainer, null,
                    React__default['default'].createElement(Logo$1, { isPushed: isPushed, togglePush: function () { return setIsPushed(function (prevState) { return !prevState; }); }, isDark: isDark, href: (_b = homeLink === null || homeLink === void 0 ? void 0 : homeLink.href) !== null && _b !== void 0 ? _b : "/" }),
                    React__default['default'].createElement(Flex, null,
                        React__default['default'].createElement(PanelBody, { isPushed: true, isMobile: isMobile, isDark: isDark, toggleTheme: toggleTheme, langs: langs, setLang: setLang, currentLang: currentLang, cakePriceUsd: cakePriceUsd, pushNav: setIsPushed, links: links, priceLink: priceLink }))),
                React__default['default'].createElement(ConnectContainer, null,
                    React__default['default'].createElement(Text, { color: "textSubtle", mx: 1, bold: true }, "$" + (cakePriceUsd ? cakePriceUsd.toFixed(3) : 0)),
                    React__default['default'].createElement(Button, { variant: "text", mx: 3, onClick: function () { return toggleTheme(!isDark); } },
                        React__default['default'].createElement(Flex, { alignItems: "center" }, isDark ? React__default['default'].createElement(SunIcon, { color: isDark ? "textDisabled" : "text", width: "24px" })
                            : React__default['default'].createElement(MoonIcon, { color: isDark ? "text" : "textDisabled", width: "24px" }))),
                    React__default['default'].createElement(UserBlock, { account: account, login: login, logout: logout }),
                    profile && React__default['default'].createElement(Avatar, { profile: profile }),
                    React__default['default'].createElement(Dropdown, { position: "top-right", target: React__default['default'].createElement(Button, { mx: 3, variant: "text" },
...
var lightColors = __assign(__assign(__assign({}, baseColors), brandColors), { background: "#a6e8b3", backgroundDisabled: "#E9EAEB", contrast: "#000000", invertedContrast: "#FFFFFF", input: "#f2fffc", tertiary: "#EFF4F5", text: "#4c4c4c", textDisabled: "#BDC2C4", textSubtle: "#4c4c4c", borderColor: "#262948", card: "#FFFFFF", gradients: {
        bubblegum: "linear-gradient(139.73deg, #E6FDFF 0%, #F3EFFF 100%)",
    } });
var darkColors = __assign(__assign(__assign({}, baseColors), brandColors), { secondary: "#2a4cca", background: "#171727", backgroundDisabled: "#1f1f1f", contrast: "#FFFFFF", invertedContrast: "#191326", input: "#1b1d31", primaryDark: "#0098A1", tertiary: "#353547", text: "#e7e8ea", textDisabled: "#666171", textSubtle: "#a8a9ad", borderColor: "#262948", card: "#1b1d31", gradients: {
